...
<div class="wrap_header">
  <div class="header clearfix">
    <div class="logo_panel clearfix">
      <div class="logo fl"><img src="${path}pay_files/logo.png" alt="logo" height="45" width="150"></div>
      <div class="lg_txt">| Alpaca支付体验平台</div>
    </div>
    <div class="fr tip_panel">
      <div class="txt">欢迎使用Alpaca支付付款</div>
      <a href="">常见问题</a>
    </div>
  </div>
</div>
  ...
  <div class="bd">
    <ul class="payment">
      <li style="margin-left: 20px;">
        ...
        <form action="${path}alpacaPay/scanPay" method="post">
      ...
      <li style="margin-left: 20px;">
        ...
        <form action="${path}alpacaPay/toF2FPay" method="post">
          <br /><br />
          <p class="pay_btn">
...
<div class="footer w100">
  <div class="container">
    ...
    <ul class="con-content">
      ...
      <li>Jason@hotmail.com</li>
    </ul>
  </div>
  <div class="copyright"> <font color="red">Copyright © fake from github.</font></div>
</div>
</body>
