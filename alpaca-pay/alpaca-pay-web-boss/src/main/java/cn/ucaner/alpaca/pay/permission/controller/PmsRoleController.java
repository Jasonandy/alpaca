package cn.ucaner.alpaca.pay.permission.controller;
...
import cn.ucaner.alpaca.pay.permission.enums.OperatorTypeEnum;
import cn.ucaner.alpaca.pay.permission.service.PmsMenuRoleService;
import cn.ucaner.alpaca.pay.permission.service.PmsMenuService;
...
import cn.ucaner.alpaca.pay.permission.service.PmsRolePermissionService;
import cn.ucaner.alpaca.pay.permission.service.PmsRoleService;
import cn.ucaner.alpaca.pay.permission.utils.ValidateUtils;

/**
* @Package：cn.ucner.alpaca.pay.permission.controller   
* @ClassName：PmsRoleController   
* @Description：   <p> 权限管理模块角色管理.<br/></p>
* @Author： - wubin   
* @CreatTime：2018年5月12日 下午12:41:12   
* @Modify By：   
