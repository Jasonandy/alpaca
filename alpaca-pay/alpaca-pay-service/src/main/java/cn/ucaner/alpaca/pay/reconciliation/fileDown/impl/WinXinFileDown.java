...
import cn.ucaner.alpaca.pay.reconciliation.utils.FileUtils;
import cn.ucaner.alpaca.pay.reconciliation.utils.SignHelper;
import cn.ucaner.alpaca.pay.reconciliation.utils.WeiXinBaseUtils;
import cn.ucaner.alpaca.pay.reconciliation.utils.https.HttpClientUtil;
import cn.ucaner.alpaca.pay.reconciliation.utils.https.HttpResponse;
import cn.ucaner.alpaca.pay.trade.utils.WeixinConfigUtil;

/**
* @Package：cn.ucaner.alpaca.pay.reconciliation.fileDown.impl   
* @ClassName：WinXinFileDown   
* @Description：   <p> 微信文件下载类 </p>
* @Author： -    
* @CreatTime：2018年5月11日 上午10:36:03   
* @Modify By：   
