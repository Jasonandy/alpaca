...
import cn.ucaner.alpaca.framework.utils.tools.json.test.test.bean.ExamInfoDict;
import cn.ucaner.alpaca.framework.utils.tools.json.test.test.bean.PerfectEvaluationProductResVo;
import cn.ucaner.alpaca.framework.utils.tools.json.test.test.bean.UserInfoDict;
