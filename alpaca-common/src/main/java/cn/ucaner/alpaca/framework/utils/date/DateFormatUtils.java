...
public class DateFormatUtils {
	...
	public static String formatDate(Date date,String format){
		return formatDate(DateUtilOne.date2String(date), format);
	}
	...
	public static String formatDate(String value){
		return getFormat(DATE_FORMAT2).format(DateUtilOne.string2Date(value, DATE_FORMAT2));
	}
	...
	public static String formatDate(Date value){
		return formatDate(DateUtilOne.date2String(value));
	}
