...
* @Package：cn.ucaner.alpaca.framework.utils.tools.core.lang   
* @ClassName：Base32   
* @Description：   <p> Base32 - encodes and decodes RFC3548 Base32 (see http://www.faqs.org/rfcs/rfc3548.html ) </p>
* base32就是用32（2的5次方）个特定ASCII码来表示256个ASCII码。所以，5个ASCII字符经过base32编码后会变为8个字符（公约数为40），长度增加3/5.不足8n用“=”补足
*<br> see http://blog.csdn.net/earbao/article/details/44453937
* @Author： -    
* @CreatTime：2018年5月25日 上午11:23:59   
* @Modify By：   
