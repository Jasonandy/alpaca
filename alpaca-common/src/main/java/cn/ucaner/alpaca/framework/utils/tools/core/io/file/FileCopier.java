...
import cn.ucaner.alpaca.framework.utils.tools.core.lang.copier.SrcToDestCopier;
import cn.ucaner.alpaca.framework.utils.tools.core.util.StrUtil;

/**
* @Package：cn.ucaner.alpaca.framework.utils.tools.core.io.file   
* @ClassName：FileCopier   
* @Description：   <p> 文件拷贝器 </p>
* 支持以下几种情况：
* <pre>
* 1、文件复制到文件
* 2、文件复制到目录
...
* </pre>
* @Author： -    
* @CreatTime：2018年5月25日 上午11:57:42   
* @Modify By：   
