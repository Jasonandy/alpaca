...
import cn.ucaner.alpaca.framework.utils.tools.log.AbstractLocationAwareLog;

/**
* @Package：cn.ucaner.alpaca.framework.utils.tools.log.dialect.jdk   
* @ClassName：JdkLog   
* @Description：   <p> <a href="http://java.sun.com/javase/6/docs/technotes/guides/logging/index.html">java.util.logging</a> log. </p>
* @Author： -    
* @CreatTime：2018年5月25日 上午10:43:24   
* @Modify By：   
...
public class JdkLog extends AbstractLocationAwareLog {
	...
	@Override
	public void log(String fqcn, cn.ucaner.alpaca.framework.utils.tools.log.level.Level level, Throwable t, String format, Object... arguments) {
		Level jdkLevel;
		switch (level) {
			case TRACE:
