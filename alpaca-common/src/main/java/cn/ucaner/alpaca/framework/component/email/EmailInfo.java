 ...
 * </html>
 */
package cn.ucaner.alpaca.framework.component.email;
...
* @ClassName：EmailInfo   
* @Description：   <p> 邮件信息 </p>
* @Author： - Jason 
* @CreatTime：2017年8月30日 下午2:18:00   
* @Modify By：   
* @ModifyTime：  
* @Modify marker：   
* @version    V1.0
...
public class EmailInfo implements Serializable {
	 ...
	 *            附件.
	 */
	public EmailInfo(String hostName, int smtpPort, String encode, boolean isSSLOnConnect, boolean isHTMLFormat, boolean isDebug, String userName,
			String passWord, String from, String senderName, String title, String content, Map<String, String> to, Map<String, String> cc,
			Map<String, String> bcc, List<AttachmentInfo> attachmentInfos) {
		super();
