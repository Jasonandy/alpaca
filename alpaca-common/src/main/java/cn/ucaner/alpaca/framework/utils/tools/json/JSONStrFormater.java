...
/**
* @Package：cn.ucaner.alpaca.framework.utils.tools.json   
* @ClassName：JSONStrFormater   
* @Description：   <p> JSON字符串格式化工具，用于简单格式化JSON字符串 </p>
* <br>from http://blog.csdn.net/lovelong8808/article/details/54580278
* @Author： -    
* @CreatTime：2018年5月25日 上午10:57:27   
* @Modify By：   
