...
import cn.ucaner.alpaca.framework.utils.tools.core.date.DateException;

/**
* @Package：cn.ucaner.alpaca.framework.utils.tools.core.date.format   
* @ClassName：FastDatePrinter   
* @Description：   <p> {@link java.text.SimpleDateFormat} 的线程安全版本，用于将 {@link Date} 格式化输出 </p>
* @Author： - wubin   
* @CreatTime：2018年5月25日 下午1:21:26   
* @Modify By：   
