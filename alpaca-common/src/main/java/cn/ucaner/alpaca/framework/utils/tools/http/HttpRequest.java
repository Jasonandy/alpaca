...
public class HttpRequest extends HttpBase<HttpRequest> {
	private static final String BOUNDARY = "--------------------Alpaca-common" + RandomUtil.randomString(16);
