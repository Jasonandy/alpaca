...
import cn.ucaner.alpaca.framework.utils.tools.core.bean.BeanDesc;
import cn.ucaner.alpaca.framework.utils.tools.core.bean.BeanDesc.PropDesc;
import cn.ucaner.alpaca.framework.utils.tools.core.bean.BeanDescCache;
import cn.ucaner.alpaca.framework.utils.tools.core.bean.BeanInfoCache;
import cn.ucaner.alpaca.framework.utils.tools.core.bean.BeanResolver;
import cn.ucaner.alpaca.framework.utils.tools.core.bean.DynaBean;
 ...
 * 把一个拥有对属性进行set和get方法的类，我们就可以称之为JavaBean。
 * </p>
 *  * @deprecated 由于Bean功能的扩充，BeanUtil类放入bean包中，请使用{@link BeanUtil}
* @Author： -    
* @CreatTime：2018年5月25日 下午1:02:40   
* @Modify By：   
